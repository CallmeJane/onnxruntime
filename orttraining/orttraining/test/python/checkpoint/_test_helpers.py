...
def train(trainer, train_data, batcher_fn, total_batch_steps = 5, seed = 1):
    """Runs train_step total_batch_steps number of times on the gicen trainer"""
...
def makedir(checkpoint_dir):
    """Creates a directory if oe does not exist"""
...
def distributed_setup(func):
    ...
    Sets up distributed environment by extractnig
    - world_rank
    - world_size
    - device
